function run_h4_pca_composite_bicoord_permutation_test(nPerm)
% RUN_H4_PCA_COMPOSITE_BICOORD_PERMUTATION_TEST(nPerm)
%
% "all6_pca" between-group, non-directional. Scores the PCA composite
% signal (pca_composite_manifest_exp1-exp2.csv, built by
% pca_composite_events.py) via relatedActivitiesTest. Fixed rng(42) seed
% for reproducibility.
%
% Writes: analysis/figures/h4_pca_composite_bicoord_permutation_test_exp1-exp2.csv,
% same schema as h4_bicoord_permutation_test_exp1-exp2.csv (minus
...
outCsv      = fullfile(repoRoot, 'analysis', 'figures', 'h4_pca_composite_bicoord_permutation_test_exp1-exp2.csv');
...
switch eventType
    ...
    otherwise
        error('run_h4_pca_composite_bicoord_permutation_test:build_event_frames:UnknownEventType', ...
